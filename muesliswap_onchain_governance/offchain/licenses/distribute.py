...
def main(
            ...
            pycardano.TransactionOutput(
                ...
                amount=pycardano.Value(
                    ...
                    multi_asset=pycardano.MultiAsset(
                        {
                            pycardano.ScriptHash(license_policy_id): {
                                pycardano.AssetName(license_name): 1,
                            },
                        }
                    ),
                ),
                datum=winning_proposal.datum if winning_proposal.datum else None,
            ),
            context,
        )
    )
    ...
    builder.validity_end = context.last_block_slot + 100
